...
public class SList {
  ...
  public void squish() {
	  ...
	  while(temp!=null){
		  if(temp.item.equals(temp.next.item)){
 ...
 * @return 
  ...
  public void twin() {
	  ...
	  while(temp!=null){
		  SListNode copy=new SListNode(temp.item,null);
		  copy.next=temp.next;
		  temp.next=copy;
		  temp=copy.next;
  ...
  private static void testAfterInsertEnd() {
    ...
    lst1.twin();
  System.out.println("list after twin is"+lst1);
    lst1.squish();
    System.out.println("list after squish is"+lst1);
  }
  }
  
  
  /*
  public static void testafterdouble(){
	  SList lst1 = new SList();
	    lst1.insertEnd(new Integer(6));
	    lst1.insertEnd(new Integer(6));
