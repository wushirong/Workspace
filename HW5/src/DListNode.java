...
public class DListNode extends ListNode {
  ...
  public static DListNode newNode(Object item, DList list,DListNode prev, DListNode next) {
  ...
  public void insertAfter(Object item) throws InvalidNodeException {
    ...
    DListNode temp=newNode(item,(DList)myList,this,this.next);
    this.next.prev=temp;
    this.next=temp;
  ...
  public void insertBefore(Object item) throws InvalidNodeException {
    ...
    DListNode temp=newNode(item,(DList)myList,this.prev,this);
    this.prev.next=temp;
    this.prev=temp;
