...
public class Homework6Test {
  ...
  public static void main(String[] args) {
	  ...
	  int bucketsLength=Integer.parseInt(args[1]);
	  HashTableChained table = new HashTableChained(bucketsLength);
	  ...
	  System.out.println("Buckets Number:"+bucketsLength);
	  System.out.println("Insert Number:"+numBoards);
	  System.out.println("Load Factor:"+numBoards*1.0/bucketsLength);
	  double theory=numBoards-bucketsLength+bucketsLength*Math.pow((1-1.0/bucketsLength),numBoards);
	  System.out.println("Theoretical collisions:"+theory);
	  int sum=0;
	  for(int i=0;i<100000;i++){
	  	initTable(table, numBoards);
	  	sum+=table.collisions();
	  }
	  System.out.println("Actual average collisions:"+sum*1.0/100000);
  }
